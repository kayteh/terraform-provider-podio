module github.com/kayteh/terraform-provider-podio
...
require (
	...
	github.com/kayteh/podio-go v0.0.0-20220422210604-355b588b7da5
)
...
replace github.com/kayteh/podio-go => ../podio-go
